 ...
 * @author 陆鹏
 */
public class TestAnimationTongJiView extends View{
    ...
    public TestAnimationTongJiView(Context context) {
        super(context);
        initPaint();

    }

    public TestAnimationTongJiView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initPaint();

    }

    public TestAnimationTongJiView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
