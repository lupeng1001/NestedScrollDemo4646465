...
public class TestViewActivity extends AppCompatActivity {
    ...
    private TestAnimationTongJiView view;
...
//        Glide.with(TestViewActivity.this).load("https://ckbcloudshop.oss-cn-hangzhou.aliyuncs.com/upload/license/48698/QYOLARIYEJFPDNSI.jpg")
//                .into((NewCustView)findViewById(R.id.local_view));
//        fillDataList();
//        view = (TestAnimationTongJiView) findViewById(R.id.local_view);
//        view.setLocal_duration(1000);
//        view.setData_list(list);
